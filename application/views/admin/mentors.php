      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="<?= site_url('admin/edit_mentor/' . $m['id']) ?>" class="btn-sm primary"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-right:4px;"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Edit</a>
              <a href="<?= site_url('admin/delete_mentor/' . $m['id']) ?>" class="btn-sm danger" onclick="return confirm('Yakin ingin menghapus mentor <?= $m['nama'] ?>?')"> Hapus</a>
            </td>
          </tr>
          <?php endforeach; ?>
          <?php endif; ?>
