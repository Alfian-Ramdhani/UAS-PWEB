        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="<?= site_url('admin/grant_premium/' . $m['id']) ?>" class="btn-sm <?= $m['membership'] === 'premium' ? 'warning' : 'primary' ?>" style="<?= $m['membership'] === 'premium' ? 'background:var(--orange-light);color:var(--orange);' : '' ?>"><?= $m['membership'] === 'premium' ? '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-right:4px;"><line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/></svg> Revoke Premium' : 'Grant Premium' ?></a>
              <a href="<?= site_url('admin/delete_member/' . $m['id']) ?>" class="btn-sm danger" onclick="return confirm('Yakin ingin menghapus akun <?= $m['nama'] ?>? Semua data progres akan ikut terhapus.')"> Hapus</a>
            </td>
          </tr>
          <?php endforeach; ?>
          <?php endif; ?>
